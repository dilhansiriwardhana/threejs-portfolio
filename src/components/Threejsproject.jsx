      ...
      <div className="webappcontainer">
        <div className="webappwraper1  ">
          ...
          <p className="wrapperdes">
            ...
            where they can interact with a rotating 3D world. Through intuitive
            navigation, users explore my portfolio content, showcasing my work
            from various angles and perspectives. This dynamic presentation not
            only captivates visitors but also provides a memorable and engaging
            way to showcase my creative projects.
            <br />
          </p>
          <div className="rolewrapper">
            ...
            <div className="myrole">
              ...
              <p>
                ...
                and immersive user experience. In this role, I have the freedom
                to explore innovative techniques and implement cutting-edge
                technologies to bring these 3D worlds to life. From creating
                captivating visual interfaces to optimizing performance for
                smooth interactions, I am responsible for every aspect of the
          ...
          <div className="projectpurpose">
            ...
            <p>
              The primary purpose of this 3D portfolio project is to showcase my
              work and projects in an innovative and captivating manner. By
          ...
          <div className="spotlight">
            ...
            />
            <p>
              In my project, I created a platform where users can interact with
              3D models within a virtual world. Initially, I encountered a
              problem with positioning the 3D models correctly. To resolve this
              issue, I decided to explore WebGL, a JavaScript API for rendering
              interactive 3D graphics in web browsers.
              <br />
              <br />
              As I delved deeper into WebGL, I discovered a solution to fix the
              positioning problem with the 3D models. WebGL provided me with a
              powerful set of tools for creating immersive and interactive
              experiences on the web. It allowed me to manipulate and render 3D
              graphics with precision and control.
              <br />
              <br />
          ...
          <div className="webstack">
            ...
            <p>
              ...
              React, Tailwind CSS, regular CSS, Three.js, WebGL, and React Three
              Fiber. React helped me manage the UI components efficiently, while
              Tailwind CSS simplified styling tasks with its ready-made classes.
              I also utilized regular CSS for specific customizations. Three.js
              and WebGL were crucial for rendering stunning 3D graphics, and
              React Three Fiber seamlessly integrated Three.js with my React
              components. With these tools, I crafted a captivating portfolio
              that showcases my work in a visually striking and interactive
              manner, reflecting my skills and creativity.
            </p>
          </div>
