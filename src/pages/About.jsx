    ...
    <section className="max-container">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          ...
          behind web pages. It was hands-on and felt like solving a puzzle. When
          I decided to build my own website, everything fell into place. HTML
          became the tool that let me organize information online.
          <br />
          <br /> Since then, I’ve been honing my skills and learning Javascript.
          I recently finished Web Development Bootcamp program. I’m seeking a
          full-time role where I can help a company achieve their goals.
        </p>
      </div>
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            ...
            and developers who have raised my standards for what’s expected of
            any web application.
            <br />
            <br />
