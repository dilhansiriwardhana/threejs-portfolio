        ...
        <div className="content">
          ...
          <div className="description">
            <p>
              ...
              specialized in <strong>WebGL</strong> He has worked on many
              projects for renowned clients to create interactive 3D experiences
              accessible to everyone from their browser{" "}
            </p>

            <p>
              Bruno has been teaching web development and WebGL in various
              schools for <strong>more than 7 years</strong>, making him a
              pedagogical trainer, alternating theory and practice.
            </p>
          </div>
          ...
          <div className="projects-title">Dilhan's Projects</div>
          <div className="projectsgrid">
            <div className="projectbox">
              <a href="www.iphonerepair.lk" className="iphonesite">
                <img src={iphonesite} alt="" />
                <h1>iPhonerepai Fullstack Website</h1>
              </a>
              <a href="www.dilhancodes.dev" className="portfolio">
                <img src={portfoliosite} alt="" />
                <h1>Portfolio website 3D</h1>
              </a>
            </div>
          </div>
        </div>
